...
const char deployment[] = "Bd0d1d2d3 Cc7d7e7 Ci3i4i5 Da3b3 Dg6g7 Df1g1 Sa5 Sc5 Se5 Sg3 ";
...
int dd[4] = {0};
int testint = 0;
int testintarr[TESTSIZE][2] = { {6,8},{6,0},{8,6},{8,2} , {0,2},{0,6},{2,8},{2,0}}; //, {0,4},{4,0},{4,8},{8,4}}; //, {2,2},{6,2},{2,6},{6,6}, {4,4} };
